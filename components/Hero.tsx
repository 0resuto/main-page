    ...
    <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-12 overflow-hidden pt-24 pb-24 md:pb-34" id="about">
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <StatCard value="Cloud" label="Nextcloud" index={0} icon={Cloud} imageUrl="/images/logo/nextcloud-logo.webp" url="https://cloud.markyarovikov.ru" />
          <StatCard value="Music" label="Navidrome" index={1} icon={Music} imageUrl="/images/logo/navidrome-logo.webp" url="https://music.markyarovikov.ru"/>
          <StatCard value="Films" label="Yamtrack" index={2} icon={Film} imageUrl="/images/logo/yamtrack-logo.webp" url="https://films.markyarovikov.ru"/>
        </div>
      </motion.div>
    </section>
  );
